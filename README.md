...
## Specifications
  ...
  | Program will display a Stylists/Create view with a form to add a new stylist when the associated link is clicked on the Stylists/Index view. | "Add New Stylist" > *Click* | "Add a New Stylist: Stylist Name: [Input Field]; [Button: Add New Stylist]" | Y |
